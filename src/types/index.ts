...
export type PublicMessage = { id: string, channelId: string, content: string, creator: string, created: number, replyTo?: string, mentions: string[] };

export type DirectMessage = { id: string, content: string, peer: string, creator: string, created: number, replyTo?: string, decrypted: boolean };
