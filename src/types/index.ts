...
export type PublicMessage = { id: string, root: string, content: string, creator: string, created: number, parent?: string, children?: PublicMessage[], mentions: string[] };

export type DirectMessage = { id: string, content: string, peer: string, creator: string, created: number, parent?: string, children?: DirectMessage[], decrypted: boolean };
